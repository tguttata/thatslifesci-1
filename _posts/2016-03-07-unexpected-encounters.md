...
Keywords: fieldwork, wild, unpredictability, humans
...
Figure 1. No, we are not with the C.I.A.
...
Figure 2. No, we are not subscribing to the latest fad weight loss gimmick.
...
Figure 3. Successful nest = successful data collection.
